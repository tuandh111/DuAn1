...
public class PasswordField extends JPasswordField {
    ...
    public PasswordField() {
        ...
        eye = new ImageIcon(getClass().getResource("/com/tuandhpc05076/icon1/eye.png")).getImage();
        eye_hide = new ImageIcon(getClass().getResource("/com/tuandhpc05076/icon1/eye_hide.png")).getImage();
