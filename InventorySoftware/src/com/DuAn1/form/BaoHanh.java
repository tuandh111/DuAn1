        ...
        for (SanPhamModel sp : list) {
            if (sp.getLoaiSP().equalsIgnoreCase("Iphone")) {
                if (i == 0) {
                    ...
                    txtHinhAnhIphone1.setImage(com.DuAn1.Helper.ShareHelper.readLogo(TenHinh));
                ...
                if (i == 1) {
                    String TenHinh = sp.getHinh().trim();
                    TenHinh = TenHinh.replace(sp.getMaSP().trim(), "");
                    txtHinhAnhIphone2.setImage(com.DuAn1.Helper.ShareHelper.readLogo(TenHinh));
                ...
                if (i == 2) {
                    String TenHinh = sp.getHinh().trim();
                    TenHinh = TenHinh.replace(sp.getMaSP().trim(), "");
                    txtHinhAnhIphone3.setImage(com.DuAn1.Helper.ShareHelper.readLogo(TenHinh));
                ...
                if (i == 3) {
                    String TenHinh = sp.getHinh().trim();
                    TenHinh = TenHinh.replace(sp.getMaSP().trim(), "");
                    txtHinhAnhIphone4.setImage(com.DuAn1.Helper.ShareHelper.readLogo(TenHinh));
                ...
                if (i == 4) {
                    String TenHinh = sp.getHinh().trim();
                    TenHinh = TenHinh.replace(sp.getMaSP().trim(), "");
                    txtHinhAnhIphone5.setImage(com.DuAn1.Helper.ShareHelper.readLogo(TenHinh));
                ...
                if (i == 5) {
                    String TenHinh = sp.getHinh().trim();
                    TenHinh = TenHinh.replace(sp.getMaSP().trim(), "");
                    txtHinhAnhIphone6.setImage(com.DuAn1.Helper.ShareHelper.readLogo(TenHinh));
                ...
                if (i == 6) {
                    String TenHinh = sp.getHinh().trim();
                    TenHinh = TenHinh.replace(sp.getMaSP().trim(), "");
                    txtHinhAnhIphone7.setImage(com.DuAn1.Helper.ShareHelper.readLogo(TenHinh));
                ...
                if (i == 7) {
                    String TenHinh = sp.getHinh().trim();
                    TenHinh = TenHinh.replace(sp.getMaSP().trim(), "");
                    txtHinhAnhIphone8.setImage(com.DuAn1.Helper.ShareHelper.readLogo(TenHinh));
                ...
                if (i == 8) {
                    String TenHinh = sp.getHinh().trim();
                    TenHinh = TenHinh.replace(sp.getMaSP().trim(), "");
                    txtHinhAnhIphone9.setImage(com.DuAn1.Helper.ShareHelper.readLogo(TenHinh));
        ...
        for (SanPhamModel sp : list) {
            if (sp.getLoaiSP().trim().equalsIgnoreCase("SamSung")) {
                if (j == 0) {
                    String TenHinh = sp.getHinh().trim();
                    TenHinh = TenHinh.replace(sp.getMaSP().trim(), "");
                    txtHinhAnhSamSung1.setImage(com.DuAn1.Helper.ShareHelper.readLogo(TenHinh));
                ...
                if (j == 1) {
                    String TenHinh = sp.getHinh().trim();
                    TenHinh = TenHinh.replace(sp.getMaSP().trim(), "");
                    txtHinhAnhSamSung2.setImage(com.DuAn1.Helper.ShareHelper.readLogo(TenHinh));
                ...
                if (j == 2) {
                    String TenHinh = sp.getHinh().trim();
                    TenHinh = TenHinh.replace(sp.getMaSP().trim(), "");
                    txtHinhAnhSamSung3.setImage(com.DuAn1.Helper.ShareHelper.readLogo(TenHinh));
                ...
                if (j == 3) {
                    String TenHinh = sp.getHinh().trim();
                    TenHinh = TenHinh.replace(sp.getMaSP().trim(), "");
                    txtHinhAnhSamSung4.setImage(com.DuAn1.Helper.ShareHelper.readLogo(TenHinh));
                ...
                if (j == 4) {
                    String TenHinh = sp.getHinh().trim();
                    TenHinh = TenHinh.replace(sp.getMaSP().trim(), "");
                    txtHinhAnhSamSung5.setImage(com.DuAn1.Helper.ShareHelper.readLogo(TenHinh));
                ...
                if (j == 8) {
                    String TenHinh = sp.getHinh().trim();
                    TenHinh = TenHinh.replace(sp.getMaSP().trim(), "");
                    txtHinhAnhSamSung9.setImage(com.DuAn1.Helper.ShareHelper.readLogo(TenHinh));
        ...
        for (SanPhamModel sp : list) {
            if (sp.getLoaiSP().trim().equalsIgnoreCase("Sony")) {
                if (z == 0) {
                    String TenHinh = sp.getHinh().trim();
                    TenHinh = TenHinh.replace(sp.getMaSP().trim(), "");
                    txtHinhAnhSony1.setImage(com.DuAn1.Helper.ShareHelper.readLogo(TenHinh));
                ...
                if (z == 1) {
                    String TenHinh = sp.getHinh().trim();
                    TenHinh = TenHinh.replace(sp.getMaSP().trim(), "");
                    txtHinhAnhSony2.setImage(com.DuAn1.Helper.ShareHelper.readLogo(TenHinh));
                ...
                if (z == 2) {
                    String TenHinh = sp.getHinh().trim();
                    TenHinh = TenHinh.replace(sp.getMaSP().trim(), "");
                    txtHinhAnhSony3.setImage(com.DuAn1.Helper.ShareHelper.readLogo(TenHinh));
                ...
                if (z == 3) {
                    String TenHinh = sp.getHinh().trim();
                    TenHinh = TenHinh.replace(sp.getMaSP().trim(), "");
                    txtHinhAnhSony4.setImage(com.DuAn1.Helper.ShareHelper.readLogo(TenHinh));
                ...
                if (z == 4) {
                    String TenHinh = sp.getHinh().trim();
                    TenHinh = TenHinh.replace(sp.getMaSP().trim(), "");
                    txtHinhAnhSony5.setImage(com.DuAn1.Helper.ShareHelper.readLogo(TenHinh));
                ...
                if (z == 5) {
                    String TenHinh = sp.getHinh().trim();
                    TenHinh = TenHinh.replace(sp.getMaSP().trim(), "");
                    txtHinhAnhSony6.setImage(com.DuAn1.Helper.ShareHelper.readLogo(TenHinh));
                ...
                if (z == 6) {
                    String TenHinh = sp.getHinh().trim();
                    TenHinh = TenHinh.replace(sp.getMaSP().trim(), "");
                    txtHinhAnhSony7.setImage(com.DuAn1.Helper.ShareHelper.readLogo(TenHinh));
                ...
                if (z == 7) {
                    String TenHinh = sp.getHinh().trim();
                    TenHinh = TenHinh.replace(sp.getMaSP().trim(), "");
                    txtHinhAnhSony8.setImage(com.DuAn1.Helper.ShareHelper.readLogo(TenHinh));
                ...
                if (z == 8) {
                    String TenHinh = sp.getHinh().trim();
                    TenHinh = TenHinh.replace(sp.getMaSP().trim(), "");
                    txtHinhAnhSony9.setImage(com.DuAn1.Helper.ShareHelper.readLogo(TenHinh));
...
//}
    ...
    private void initComponents() {
        ...
        txtMaSPcu = new com.DuAn1.Swing.TextField();
        txtMaHDCu = new com.DuAn1.Swing.TextField();
        ...
        txtemei.setEnabled(false);
        txtemei.setLabelText("Số lượng cũ");
        txtemei.addCaretListener(new javax.swing.event.CaretListener() {
            public void caretUpdate(javax.swing.event.CaretEvent evt) {
                txtemeiCaretUpdate(evt);
            }
        });
        txtemei.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                txtemeiMousePressed(evt);
            }
        });
        txtemei.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtemeiActionPerformed(evt);
            }
        });

        txtMaSPcu.setEditable(false);
        txtMaSPcu.setEnabled(false);
        txtMaSPcu.setLabelText("Mã sản phẩm cũ");
        txtMaSPcu.addCaretListener(new javax.swing.event.CaretListener() {
            public void caretUpdate(javax.swing.event.CaretEvent evt) {
                txtMaSPcuCaretUpdate(evt);
            }
        });
        txtMaSPcu.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                txtMaSPcuMousePressed(evt);
            }
        });
        txtMaSPcu.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtMaSPcuActionPerformed(evt);
            }
        });

        txtMaHDCu.setEditable(false);
        txtMaHDCu.setEnabled(false);
        txtMaHDCu.setLabelText("Mã hóa đơn");
        txtMaHDCu.addCaretListener(new javax.swing.event.CaretListener() {
            public void caretUpdate(javax.swing.event.CaretEvent evt) {
                txtMaHDCuCaretUpdate(evt);
            }
        });
        txtMaHDCu.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                txtMaHDCuMousePressed(evt);
            }
        });
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(txtMaSPcu, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(txtMaHDCu, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(28, 28, 28)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
        ...
        jPanel6Layout.setVerticalGroup(
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                ...
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(lbISamSung2, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(lbISamSung3, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(31, 31, 31)
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(lbISamSung4, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(lbISamSung5, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(materialTabbed1, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 551, Short.MAX_VALUE)
...
//        txtNgayXuat.setText(formatted);
    ...
    private void btnXemDSBHActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXemDSBHActionPerformed
        ...
        txtSoluong.setText(String.valueOf(DanhSachBH1.getMaSP().trim()));
...
//        dateChooser.showPopup();
    ...
    private void button9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button9ActionPerformed
        ...
        txtMaSPcu.setText(ThongTinSPDaMua.getMaSPChiTietBaoHanh());
        txtMaHDCu.setText(ThongTinSPDaMua.getMaHDChiTietBaoHanh());
        txtemei.setText(ThongTinSPDaMua.getSoLuong());
    ...
    boolean checkbtnBH() {
        if (Double.parseDouble(txtSoluong.getText()) < Double.parseDouble(txtemei.getText())) {
            DialogHelper.alert(this, "Không đủ số lượng bảo hành cho khách hàng");
            return false;
        }
        if (txtMaBH.getText().equals("")) {
        ...
        String formatted = current.format(formatter);
        try {
            Date NgayHienTai = sdf.parse(formatted);
            Date NgayHetHan = sdf.parse(txtNgayHetHan.getText());
                      
            if (NgayHienTai.compareTo(NgayHetHan) < 0) {
        ...
        try {
            Date date1 = sdf.parse(txtNgayBaoHanh.getText());
            Date date2 = sdf.parse(txtNgayHetHan.getText());
            if (date1.compareTo(date2) > 0) {
                DialogHelper.alert(this, "Ngày het han khong duoc nho hon ngay bat dau");
                return false;
            }
        } catch (ParseException ex) {
            Logger.getLogger(BaoHanh.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void txtemeiMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_txtemeiMousePressed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtemeiMousePressed

    private void txtemeiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtemeiActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtemeiActionPerformed

    private void txtMaSPcuCaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_txtMaSPcuCaretUpdate
        // TODO add your handling code here:
    }//GEN-LAST:event_txtMaSPcuCaretUpdate

    private void txtMaSPcuMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_txtMaSPcuMousePressed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtMaSPcuMousePressed

    private void txtMaSPcuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtMaSPcuActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtMaSPcuActionPerformed

    private void txtMaHDCuCaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_txtMaHDCuCaretUpdate
        // TODO add your handling code here:
    }//GEN-LAST:event_txtMaHDCuCaretUpdate

    private void txtMaHDCuMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_txtMaHDCuMousePressed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtMaHDCuMousePressed
    ...
    private com.DuAn1.Swing.TextField txtMaHDCu;
    ...
    private com.DuAn1.Swing.TextField txtMaSPcu;
