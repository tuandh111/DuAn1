 ...
 */
public class KHDC extends javax.swing.JDialog {
    ...
    public KHDC(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(KHDC.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                KHDC dialog = new KHDC(new javax.swing.JFrame(), true);
