 ...
 * @author DELL E5470
 */
public class HoaDonCho extends javax.swing.JDialog {

    /**
     * Creates new form DanhSachHoaDon
     */
    public HoaDonCho(java.awt.Frame parent,boolean modal) {
               super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HoaDonCho.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                HoaDonCho dialog = new HoaDonCho(new javax.swing.JFrame(),true);
