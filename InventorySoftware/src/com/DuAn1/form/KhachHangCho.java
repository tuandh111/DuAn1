 ...
 * @author DELL E5470
 */
public class KhachHangCho extends javax.swing.JDialog {

    /**
     * Creates new form DanhSachHoaDon
     */
    public KhachHangCho(java.awt.Frame parent,boolean modal) {
               super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Danh sách khách hàng chờ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(KhachHangCho.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                KhachHangCho dialog = new KhachHangCho(new javax.swing.JFrame(),true);
