 ...
 */
package com.DuAn1.ChartAn;
import com.DuAn1.SwingAn.BlankPlotChart;
import com.DuAn1.ChartAn.BlankPlotChatRender;
import com.DuAn1.ChartAn.SeriesSize;
...
DecimalFormat df = new DecimalFormat("#,##0.##");
    ...
    private void initComponents() {
        ...
        blankPlotChart1 = new com.DuAn1.SwingAn.BlankPlotChart();
        panelLegend = new javax.swing.JPanel();
        panelLegend1 = new javax.swing.JPanel();
        blankPlotChart = new com.DuAn1.SwingAn.BlankPlotChart();

        panelLegend.setOpaque(false);
        panelLegend.setLayout(new java.awt.FlowLayout(java.awt.FlowLayout.CENTER, 5, 0));
        blankPlotChart1.add(panelLegend);
        panelLegend.setBounds(0, 0, 10, 0);

        panelLegend1.setOpaque(false);
        panelLegend1.setLayout(new java.awt.FlowLayout(java.awt.FlowLayout.CENTER, 5, 0));

        javax.swing.GroupLayout layout = new javax.swing.GroupLayout(this);
        this.setLayout(layout);
        layout.setHorizontalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(panelLegend1, javax.swing.GroupLayout.DEFAULT_SIZE, 400, Short.MAX_VALUE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                .addComponent(blankPlotChart, javax.swing.GroupLayout.DEFAULT_SIZE, 272, Short.MAX_VALUE)
                .addGap(0, 0, 0)
                .addComponent(panelLegend1, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE))
        );
...
private void initComponent() {
    ...
    private com.DuAn1.SwingAn.BlankPlotChart blankPlotChart;
    private com.DuAn1.SwingAn.BlankPlotChart blankPlotChart1;
