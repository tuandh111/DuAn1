...
public class NewSignin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtMatKhau.setLabelText("Tài khoản");
        ...
        txtPass.setLineColor(new java.awt.Color(0, 102, 204));
        txtPass.setSelectedTextColor(new java.awt.Color(169, 224, 49));
        txtPass.setSelectionColor(new java.awt.Color(169, 224, 49));
        txtPass.setShowAndHide(true);
        jPanel1.add(txtPass, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 300, 260, -1));
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        String user = txtMatKhau.getText();
    ...
    private com.tuandhpc05076.Swing.TextField txtMatKhau;
    private com.tuandhpc05076.Swing.PasswordField txtPass;
